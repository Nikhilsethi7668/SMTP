        ...
        <div className="flex-1 overflow-auto p-6">
          <Card className="border border-gray-200 shadow-sm">
            <CardHeader className="flex flex-row items-center justify-start space-x-2 pb-2">
              ...
              <CardTitle className="text-xl font-semibold text-gray-800">Sending Domains</CardTitle>
            </CardHeader>
              ...
              <Table>
                ...
                <TableBody>
                  {domains.map((domain, index) => (
                    <TableRow key={index} className="transition hover:bg-blue-50">
                      <TableCell className="font-medium text-gray-800">{domain.name}</TableCell>
                      <TableCell>
                        {domain.status === "Pending" ? (
                          <span className="flex w-fit items-center gap-1 rounded-full bg-yellow-100 px-2 py-1 text-sm font-medium text-yellow-700">
                            <Clock size={14} /> Pending
                          </span>
                        ) : (
                          <span className="flex w-fit items-center gap-1 rounded-full bg-green-100 px-2 py-1 text-sm font-medium text-green-700">
                      ...
                      <TableCell>
                        <div className="flex gap-2">
                          ...
                          {domain.status === "Pending" && (
                            <Button
                              onClick={() => toast.info("Under Maintainnce")}
              ...
              <div className="mt-1 flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    variant="outline"
                    size="icon"
                    onClick={() => copyToClipboard("pmta._domainkey")}
                  >
                    <Copy size={14} />
                  </Button>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    size="icon"
                    onClick={() =>
                      copyToClipboard("v=DKIM1; k=rsa; p=CcfbURDY5nx3ax0621mppRgdJbJncI...")
                    }
                  >
                    <Copy size={14} />
                  </Button>
              ...
              <div className="mt-1 flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    variant="outline"
                    size="icon"
                    onClick={() => copyToClipboard(`tracking.${selectedDomain?.name}`)}
                  >
                    <Copy size={14} />
                  </Button>
                </div>
